...
def get_weekday(current_weekday, days_ahead):
    ...
    Return which day of the week it will be days_ahead
    days from current_weekday.
    
    current_weekday is the current day of the week and 
    is in the range 1-7, indicating whether today is 
...
def get_birthday_weekday(current_weekday, current_day, birthday_day):
    ...
    given that the day of the week is current_weekday and
    the day of the year is current_day.
